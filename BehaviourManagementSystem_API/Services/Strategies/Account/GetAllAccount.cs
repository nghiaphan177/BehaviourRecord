...
{
    public class GetAllAccount : IAccountStratery
    {
        private readonly ApplicationDbContext _context;
        private readonly UserManager<User> _userManager;
        private readonly IRoleService _roleService;

        public GetAllAccount(ApplicationDbContext context, UserManager<User> userManager, IRoleService roleService)
        {
            _context = context;
