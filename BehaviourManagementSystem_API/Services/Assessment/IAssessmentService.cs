...
namespace BehaviourManagementSystem_API.Services
{
    public interface IAssessmentService
    {
        ...
        Task<ResponseResult<Assessment>> DeleteRecord(string ass_id);
        Task<ResponseResult<Assessment>> UpdateAnalyzeBehaviour(string ass_id, string ana_behaviour);
        Task<ResponseResult<Assessment>> DeleteAnalyzeBehaviour(string ass_id);
        ...
        Task<ResponseResult<Assessment>> DeleteAnalyzeAntecedent(string ass_id);
        ...
        Task<ResponseResult<Assessment>> DeleteAnalyzeConsequence(string ass_id);
        Task<ResponseResult<Assessment>> UpdateFuntionAntecedent(string ass_id, string fun_ant);
        Task<ResponseResult<Assessment>> DeleteFuntionAntecedent(string ass_id);
        Task<ResponseResult<Assessment>> UpdateFuntionConsequece(string ass_id, string fun_con);
        Task<ResponseResult<Assessment>> DeleteFuntionConsequece(string ass_id);
    }
}
