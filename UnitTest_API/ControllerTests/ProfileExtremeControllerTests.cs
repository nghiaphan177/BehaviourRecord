...
{
    /// <summary>
    /// ProfileExtreme_UnitTest
    /// writter: HoangDDN
    /// Description: Get,Add,Update,Remove,GetbyId
    /// </summary>

    public class ProfileExtremeControllerTests
    {
        private readonly ProfileExtremeController _controller;
        private readonly IProfileExtremeService _service;

        public ProfileExtremeControllerTests()
        {
            _service = new ProfileExtremeServiceFakes();
            _controller = new ProfileExtremeController(_service);
        }
