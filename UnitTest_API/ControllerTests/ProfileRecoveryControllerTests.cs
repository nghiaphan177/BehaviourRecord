...
{
    /// <summary>
    /// ProfileRecovery_UnitTest
    /// writter: HoangDDN
    /// Description: Get,Add,Update,Remove,GetbyId
    /// </summary>

    public class ProfileRecoveryControllerTests
    {
        private readonly ProfileRecoveryController _controller;
        private readonly IProfileRecoveryService _service;

        public ProfileRecoveryControllerTests()
        {
            _service = new ProfileRecoveryServiceFakes();
            _controller = new ProfileRecoveryController(_service);
        }
