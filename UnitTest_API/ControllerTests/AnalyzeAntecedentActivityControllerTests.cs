...
{
    /// <summary>
    /// AntecedentActivity_UnitTest
    /// writter: HoangDDN
    /// Description: Get,Add,Update,Remove,GetbyId
    /// </summary>

    public class AnalyzeAntecedentActivityControllerTests
    {
        private readonly AnalyzeAntecedentActivityController _controller;
        private readonly IAnalyzeAntecedentActivityService _service;

        public AnalyzeAntecedentActivityControllerTests()
        {
            _service = new AnalyzeAntecedentActivityServiceFakes();
            _controller = new AnalyzeAntecedentActivityController(_service);
        }
