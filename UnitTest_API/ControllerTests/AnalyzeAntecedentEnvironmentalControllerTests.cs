...
{
    /// <summary>
    /// AntecedentEnvironmental_UnitTest
    /// writter: HoangDDN
    /// Description: Get,Add,Update,Remove,GetbyId
    /// </summary>

    public class AnalyzeAntecedentEnvironmentalControllerTests
    {
        private readonly AnalyzeAntecedentEnvironmentalController _controller;
        private readonly IAnalyzeAntecedentEnvironmentalService _service;

        public AnalyzeAntecedentEnvironmentalControllerTests()
        {
            _service = new AnalyzeAntecedentEnvironmentalServiceFakes();
            _controller = new AnalyzeAntecedentEnvironmentalController(_service);
        }
