...
{
    /// <summary>
    /// ProfileModerate_UnitTest
    /// writter: HoangDDN
    /// Description: Get,Add,Update,Remove,GetbyId
    /// </summary>

    public class ProfileModerateControllerTests
    {
        private readonly ProfileModerateController _controller;
        private readonly IProfileModerateService _service;

        public ProfileModerateControllerTests()
        {
            _service = new ProfileModerateServiceFakes();
            _controller = new ProfileModerateController(_service);
        }
